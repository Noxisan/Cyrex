...
- **macOS** — `*-arm64.dmg` (Apple Silicon) or the unsuffixed `*.dmg` (Intel). The build is currently unsigned, so on first launch allow it under System Settings → Privacy & Security.
